...
function listMovie(movie){
    ...
    <div class="movie-card">
        ...
        <img class="movie-poster" src="${imageBaseUrl}/w342${movie.posterPath}" alt="${movie.overview}" title="${movie.title}"/>
...
const movieCardsEl = document.getElementsByClassName("movie-poster")
...
/*for(var i = 0; i < movieCardsEl.length; i++){
    movieCardsEl[i].addEventListener('click', function(){toggleModal(i)})
}*/
